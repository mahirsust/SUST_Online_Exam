            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="alert alert-success alert-dismissible fade in mb-2" role="alert">
                        ...
                        <strong>Well done! {{Auth::user()->name}}</strong> You successfully login in the <a href="#" class="alert-link">DashBoard</a> of SUST OnliNE Exam.
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-block">
                                <div class="media">
                                    <div class="media-body text-xs-left">
                                        <h3 class="deep-orange">20</h3>
                                        <span>Highest Mark</span>
                                    </div>
                                    <div class="media-right media-middle">
                                        <i class="icon-connection-bars deep-orange font-large-2 float-xs-right"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="card-block">
                                <div class="media">
                                    ...
                                    <div class="media-right media-middle">
                                        <i class="icon-ios-checkmark cyan font-large-2 float-xs-right"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
